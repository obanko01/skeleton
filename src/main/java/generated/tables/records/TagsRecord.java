...
public class TagsRecord extends UpdatableRecordImpl<TagsRecord> implements Record4<Integer, Time, Integer, String> {
	...
	private static final long serialVersionUID = -1920762725;
	...
	/**
	 * Setter for <code>public.tags.born</code>.
	 */
	public void setBorn(Time value) {
		setValue(1, value);
	}

	/**
	 * Getter for <code>public.tags.born</code>.
	 */
	public Time getBorn() {
	 ...
	 */
	public TagsRecord(Integer id, Time born, Integer receiptId, String tagName) {
		super(Tags.TAGS);
