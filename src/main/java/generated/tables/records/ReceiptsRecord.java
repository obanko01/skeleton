...
public class ReceiptsRecord extends UpdatableRecordImpl<ReceiptsRecord> implements Record5<Integer, Timestamp, String, BigDecimal, Integer> {

	private static final long serialVersionUID = -1712746845;
	 ...
	 */
	@Override
	public ReceiptsRecord values(Integer value1, Timestamp value2, String value3, BigDecimal value4, Integer value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ReceiptsRecord(Integer id, Timestamp uploaded, String merchant, BigDecimal amount, Integer receiptType) {
		super(Receipts.RECEIPTS);
